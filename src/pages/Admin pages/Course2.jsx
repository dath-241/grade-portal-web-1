            ...
            <div className="ml-8 mr-8 mt-6 w-auto h-[580px] p-4 border border-gray-300 rounded-[24px] bg-gray-50 ">
                ...
                <div className="flex-col items-center w-full h-[560px] overflow-y-auto p-4 bg-gray-50">
                    <table className="min-w-full border-collapse bg-white">
                        <thead>
                            <tr>
                                <th className="px-4 py-2 border-b border-gray-300">Mã môn học</th>
                                <th className="px-4 py-2 border-b border-gray-300">Số lượng môn</th>
                                <th className="px-4 py-2 border-b border-gray-300">Số lượng lớp</th>
                            </tr>
                        </thead>
                        <tbody>
