import { Button, Col, Row, Table, Typography, Modal } from "antd"; // Nhập khẩu Modal
import React from "react";
import { useNavigate } from "react-router-dom"; // Nhập khẩu useNavigate
import Navbar from "../components/Navbar";
import "./Sinhvien2.css";
  ...
  const handleCheckResult = (subject) => {
    ...
    const content = (
      <div>
        ...
        <p><strong>Điểm Quiz:</strong> {scores.quiz}</p>
        <p><strong>Điểm BTL:</strong> {scores.btl}</p>
        <p><strong>Điểm thi giữa kỳ:</strong> {scores.midterm}</p>
        <p><strong>Điểm thi cuối kỳ:</strong> {scores.final}</p>
      </div>
    );
